...
def calculate_partial_derivatives():
    ...
    # SV30 actual = 22.8991 + (-0.1588 * T1) + (-0.3609 * T2) + (0.8994 * T3) + 
    #              (0.0048 * T1^2) + (-0.0188 * T1*T2) + (0.0227 * T1*T3) + 
    #              (-0.0049 * T2^2) + (0.0096 * T2*T3) + (-0.0060 * T3^2) + 
    #              (-0.0001 * T1^3) + (0.0008 * T1^2*T2) + (-0.0010 * T1^2*T3) + 
    #              (-0.0018 * T1*T2^2) + (0.0030 * T1*T2*T3) + (-0.0008 * T1*T3^2) + 
    #              (0.0022 * T2^3) + (-0.0059 * T2^2*T3) + (0.0049 * T2*T3^2) + (-0.0015 * T3^3)
    
    function_expr = (22.8991 + 
                     (-0.1588) * T1 + 
                     (-0.3609) * T2 + 
                     0.8994 * T3 + 
                     0.0048 * T1**2 + 
