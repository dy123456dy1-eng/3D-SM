...
def perform_regression_analysis(df):
    ...
    y = df.iloc[:, -1]  # Last column: SV30 actual value
    ...
    for name, model in models.items():
        ...
        if name == 'Linear Regression' or name == 'Ridge Regression' or name == 'Lasso Regression':
            ...
            print(f"  Fitting Function: SV30 Actual = {intercept:.4f}", end="")
            ...
            print(f"  Fitting Function: SV30 Actual = {linear_model.intercept_:.4f}", end="")
...
def main():
    ...
    for name, result in results.items():
        if name == 'Linear Regression' or name == 'Ridge Regression' or name == 'Lasso Regression':
            ...
            formula = f"SV30 Actual = {intercept:.4f}"
            for i, c in enumerate(coef):
            ...
            formula = f"SV30 Actual = {linear_model.intercept_:.4f}"
            for i, coef in enumerate(linear_model.coef_):
