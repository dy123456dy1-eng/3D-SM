...
def calculate_partial_derivatives():
    ...
    # Cubic polynomial regression function expression (based on regression analysis results)
    # SVI30 Actual = 184.7208 + (-6.9881 * T1) + (5.5784 * T2) + (1.1840 * T3) + 
    #               (0.0554 * T1^2) + (-0.1149 * T1*T2) + (0.2335 * T1*T3) + 
    #               (-0.0720 * T2^2) + (-0.2580 * T2*T3) + (0.2937 * T3^2) + 
    #               (-0.0001 * T1^3) + (0.0035 * T1^2*T2) + (-0.0055 * T1^2*T3) + 
    #               (-0.0080 * T1*T2^2) + (0.0119 * T1*T2*T3) + (-0.0013 * T1*T3^2) + 
    #               (0.0185 * T2^3) + (-0.0500 * T2^2*T3) + (0.0485 * T2*T3^2) + (-0.0185 * T3^3)
    
    function_expr = (184.7208 + 
                     (-6.9881) * T1 + 
                     5.5784 * T2 + 
                     1.1840 * T3 + 
                     0.0554 * T1**2 + 
    ...
    output_file = 'Partial Derivative Results.xlsx'
