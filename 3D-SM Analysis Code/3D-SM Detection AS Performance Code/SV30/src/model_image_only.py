...
class ImprovedResNet34(nn.Module):
    """
    Improved ResNet-34 model for feature extraction
    ...
    def __init__(self, pretrained=True):
        super(ImprovedResNet34, self).__init__()
        ...
        # Input: (batch_size, 512, 7, 7) - Output of ResNet34's last convolutional layer
...
class ImageOnlyModel(nn.Module):
    ...
    Model architecture:
    1. Use improved ResNet-34 to extract features from 3 images
    ...
    def __init__(self, num_classes=1):
        ...
        # Image feature extractor (3 identical improved ResNet34)
        self.image_feature_extractor = ImprovedResNet34()
